...
namespace Flux.TranstemLab.StepDefinitions.Facilities
{
    ...
    public class FacilitySteps : TranstemLabTestBase
    {
        ...
        {
            pages.createFacilityPage = pages.transtemLabHomePage.ClickOnEntityManagement();
        }

        [Then(@"I click on Facilities option from Home page")]
        public void ThenIClickOnFacilitiesOptionFromHomePage()
        {
            pages.createFacilityPage.ClickOnFacilities();
        }

        [Then(@"I click on Add Facility button")]
        public void ThenIClickOnAddFacilityButton()
        {
